    ...
    try:
        ...
        for idx, m_url in enumerate(
            ...
            try:
                ...
                # Independent predictions per match — a match can fire
                # the home margin signal, the away margin signal, both
                # (not possible in practice, since only one side can be
                # 2+ goals up), or neither.
