...
class SixtyFiveScoresScraper:
    ...
    # ---------------- TEAM HISTORY ----------------
    def get_team_recent_matches(self, team_id, count=5, exclude_match_id=None):
        """
    ...
    def analyze_team(self, team_id, team_name=None, exclude_match_id=None):
        ...
        recent = self.get_team_recent_matches(
            team_id, count=5, exclude_match_id=exclude_match_id
        )
        results = []
        for m in recent:
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "team's 5 finished matches BEFORE that fixture (its own "
